...
- <span style="color:#ff0000">**${\color{red}Flechas \space Rojas}$**</span>, Módulo A utiliza funcionalidad de Módulo B
- <span style="color:#ff99cc">**${\color{pink}Flechas \space Rosas}$**</span>, Módulo A es implementado en Módulo B
